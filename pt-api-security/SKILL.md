...
2. **Acquire per-role sessions:** via [`authenticated-session-acquisition`](../pt-authenticated-session-acquisition/SKILL.md) (MFA/OTP/SRP → reusable tokens) into the harness's token store.
