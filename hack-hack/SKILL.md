...
- [IDOR Broken Object Authorization](../hack-idor-broken-object-authorization/SKILL.md)
- [CMDi Command Injection](../hack-cmdi-command-injection/SKILL.md)
- [Path Traversal LFI](../hack-path-traversal-lfi/SKILL.md)
- [CSRF Cross Site Request Forgery](../hack-csrf-cross-site-request-forgery/SKILL.md)
- [API Security Router](../hack-api-sec/SKILL.md)
- [JWT OAuth Token Attacks](../hack-jwt-oauth-token-attacks/SKILL.md)
- [OAuth OIDC Misconfiguration](../hack-oauth-oidc-misconfiguration/SKILL.md)
- [CORS Cross Origin Misconfiguration](../hack-cors-cross-origin-misconfiguration/SKILL.md)
- [SAML SSO Assertion Attacks](../hack-saml-sso-assertion-attacks/SKILL.md)
- [Authentication Bypass](../hack-authbypass-authentication-flaws/SKILL.md)
...
- [Type Juggling (PHP)](../hack-type-juggling/SKILL.md)
- [HTTP Parameter Pollution](../hack-http-parameter-pollution/SKILL.md)
- [Race Condition](../hack-race-condition/SKILL.md)
- [XSLT Injection](../hack-xslt-injection/SKILL.md)
- [Insecure Source Code Management](../hack-insecure-source-code-management/SKILL.md)
- [CSV Formula Injection](../hack-csv-formula-injection/SKILL.md)
- [WebSocket Security](../hack-websocket-security/SKILL.md)
- [Dependency Confusion](../hack-dependency-confusion/SKILL.md)
- [Ghost Bits Cast Attack](../hack-ghost-bits-cast-attack/SKILL.md)
